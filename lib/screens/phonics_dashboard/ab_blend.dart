// lib/screens/phonics_dashboard/ab_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/ab_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class AbBlendScreen extends StatefulWidget {
  @override
  _AbBlendScreenState createState() => _AbBlendScreenState();
}

class _AbBlendScreenState extends State<AbBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/ab_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: abFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(abFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
