// lib/screens/phonics_dashboard/ack_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/ack_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class AckBlendScreen extends StatefulWidget {
  @override
  _AckBlendScreenState createState() => _AckBlendScreenState();
}

class _AckBlendScreenState extends State<AckBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/ack_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: ackFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(ackFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
