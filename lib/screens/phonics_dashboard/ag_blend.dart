// lib/screens/phonics_dashboard/ag_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/ag_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class AgBlendScreen extends StatefulWidget {
  @override
  _AgBlendScreenState createState() => _AgBlendScreenState();
}

class _AgBlendScreenState extends State<AgBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/ag_blend_words/${fileName.toLowerCase()}.mp3";
          ...
          children: [
            PageView.builder(
              ...
              itemBuilder: (context, index) {
                return _buildLessonPage(agFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
