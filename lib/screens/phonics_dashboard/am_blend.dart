// lib/screens/phonics_dashboard/am_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/am_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class AmBlendScreen extends StatefulWidget {
  @override
  _AmBlendScreenState createState() => _AmBlendScreenState();
}

class _AmBlendScreenState extends State<AmBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/am_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: amFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(amFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
