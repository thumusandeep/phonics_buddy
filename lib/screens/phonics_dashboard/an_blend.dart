// lib/screens/phonics_dashboard/an_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/an_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class AnBlendScreen extends StatefulWidget {
  @override
  _AnBlendScreenState createState() => _AnBlendScreenState();
}

class _AnBlendScreenState extends State<AnBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/an_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: anFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(anFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
