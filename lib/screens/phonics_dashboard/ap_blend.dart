// lib/screens/phonics_dashboard/ap_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/ap_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class ApBlendScreen extends StatefulWidget {
  @override
  _ApBlendScreenState createState() => _ApBlendScreenState();
}

class _ApBlendScreenState extends State<ApBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/ap_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: apFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(apFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
