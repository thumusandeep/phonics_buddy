...
import '../../data/phonics_content/at_data.dart'; // Import your list of 7 words
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class AtBlendScreen extends StatefulWidget {
  @override
  _AtBlendScreenState createState() => _AtBlendScreenState();
}

class _AtBlendScreenState extends State<AtBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/at_blend_words/${fileName.toLowerCase()}.mp3";
    debugPrint("the path is:  $path");
          ...
          children: [
            PageView.builder(
              ...
              itemBuilder: (context, index) {
                return _buildLessonPage(atFamilyWords[index]);
              },
            ),
