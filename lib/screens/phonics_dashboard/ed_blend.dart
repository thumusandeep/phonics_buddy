// lib/screens/phonics_dashboard/ed_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/ed_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class EdBlendScreen extends StatefulWidget {
  @override
  _EdBlendScreenState createState() => _EdBlendScreenState();
}

class _EdBlendScreenState extends State<EdBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/ed_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: edFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(edFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
