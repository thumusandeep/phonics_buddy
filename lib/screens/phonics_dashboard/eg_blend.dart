// lib/screens/phonics_dashboard/eg_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/eg_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class EgBlendScreen extends StatefulWidget {
  @override
  _EgBlendScreenState createState() => _EgBlendScreenState();
}

class _EgBlendScreenState extends State<EgBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/eg_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: egFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(egFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
