// lib/screens/phonics_dashboard/ell_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/ell_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class EllBlendScreen extends StatefulWidget {
  @override
  _EllBlendScreenState createState() => _EllBlendScreenState();
}

class _EllBlendScreenState extends State<EllBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/ell_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: ellFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(ellFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
