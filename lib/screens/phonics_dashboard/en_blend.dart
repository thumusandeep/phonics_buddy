// lib/screens/phonics_dashboard/en_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/en_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class EnBlendScreen extends StatefulWidget {
  @override
  _EnBlendScreenState createState() => _EnBlendScreenState();
}

class _EnBlendScreenState extends State<EnBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/en_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: enFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(enFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
