// lib/screens/phonics_dashboard/end_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/end_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class EndBlendScreen extends StatefulWidget {
  @override
  _EndBlendScreenState createState() => _EndBlendScreenState();
}

class _EndBlendScreenState extends State<EndBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/end_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: endFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(endFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
