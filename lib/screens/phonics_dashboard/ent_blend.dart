// lib/screens/phonics_dashboard/ent_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/ent_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class EntBlendScreen extends StatefulWidget {
  @override
  _EntBlendScreenState createState() => _EntBlendScreenState();
}

class _EntBlendScreenState extends State<EntBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/ent_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: entFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(entFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
