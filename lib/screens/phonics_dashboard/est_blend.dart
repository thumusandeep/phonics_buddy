// lib/screens/phonics_dashboard/est_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/est_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class EstBlendScreen extends StatefulWidget {
  @override
  _EstBlendScreenState createState() => _EstBlendScreenState();
}

class _EstBlendScreenState extends State<EstBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/est_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: estFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(estFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
