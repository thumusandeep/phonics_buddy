// lib/screens/phonics_dashboard/et_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/et_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class EtBlendScreen extends StatefulWidget {
  @override
  _EtBlendScreenState createState() => _EtBlendScreenState();
}

class _EtBlendScreenState extends State<EtBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/et_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: etFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(etFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
