// lib/screens/phonics_dashboard/id_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/id_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class IdBlendScreen extends StatefulWidget {
  @override
  _IdBlendScreenState createState() => _IdBlendScreenState();
}

class _IdBlendScreenState extends State<IdBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/id_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: idFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(idFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
