// lib/screens/phonics_dashboard/ig_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/ig_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class IgBlendScreen extends StatefulWidget {
  @override
  _IgBlendScreenState createState() => _IgBlendScreenState();
}

class _IgBlendScreenState extends State<IgBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/ig_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: igFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(igFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
