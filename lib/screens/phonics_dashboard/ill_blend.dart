// lib/screens/phonics_dashboard/ill_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/ill_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class IllBlendScreen extends StatefulWidget {
  @override
  _IllBlendScreenState createState() => _IllBlendScreenState();
}

class _IllBlendScreenState extends State<IllBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/ill_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: illFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(illFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
