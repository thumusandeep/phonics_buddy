// lib/screens/phonics_dashboard/im_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/im_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class ImBlendScreen extends StatefulWidget {
  @override
  _ImBlendScreenState createState() => _ImBlendScreenState();
}

class _ImBlendScreenState extends State<ImBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/im_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: imFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(imFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
