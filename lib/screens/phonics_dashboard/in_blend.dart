// lib/screens/phonics_dashboard/in_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/in_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class InBlendScreen extends StatefulWidget {
  @override
  _InBlendScreenState createState() => _InBlendScreenState();
}

class _InBlendScreenState extends State<InBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/in_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: inFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(inFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
