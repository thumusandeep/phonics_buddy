// lib/screens/phonics_dashboard/ip_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/ip_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class IpBlendScreen extends StatefulWidget {
  @override
  _IpBlendScreenState createState() => _IpBlendScreenState();
}

class _IpBlendScreenState extends State<IpBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/ip_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: ipFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(ipFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
