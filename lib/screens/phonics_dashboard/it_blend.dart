// lib/screens/phonics_dashboard/it_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/it_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class ItBlendScreen extends StatefulWidget {
  @override
  _ItBlendScreenState createState() => _ItBlendScreenState();
}

class _ItBlendScreenState extends State<ItBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/it_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: itFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(itFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
