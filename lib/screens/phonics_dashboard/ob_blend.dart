// lib/screens/phonics_dashboard/ob_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/ob_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class ObBlendScreen extends StatefulWidget {
  @override
  _ObBlendScreenState createState() => _ObBlendScreenState();
}

class _ObBlendScreenState extends State<ObBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/ob_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: obFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(obFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
