// lib/screens/phonics_dashboard/ock_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/ock_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class OckBlendScreen extends StatefulWidget {
  @override
  _OckBlendScreenState createState() => _OckBlendScreenState();
}

class _OckBlendScreenState extends State<OckBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/ock_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: ockFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(ockFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
