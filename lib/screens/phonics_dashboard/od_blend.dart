// lib/screens/phonics_dashboard/od_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/od_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class OdBlendScreen extends StatefulWidget {
  @override
  _OdBlendScreenState createState() => _OdBlendScreenState();
}

class _OdBlendScreenState extends State<OdBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/od_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: odFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(odFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
