// lib/screens/phonics_dashboard/og_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/og_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class OgBlendScreen extends StatefulWidget {
  @override
  _OgBlendScreenState createState() => _OgBlendScreenState();
}

class _OgBlendScreenState extends State<OgBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/og_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: ogFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(ogFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
