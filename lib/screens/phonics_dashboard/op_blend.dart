// lib/screens/phonics_dashboard/op_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/op_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class OpBlendScreen extends StatefulWidget {
  @override
  _OpBlendScreenState createState() => _OpBlendScreenState();
}

class _OpBlendScreenState extends State<OpBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/op_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: opFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(opFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
