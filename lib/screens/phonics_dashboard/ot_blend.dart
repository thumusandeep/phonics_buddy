// lib/screens/phonics_dashboard/ot_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/ot_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class OtBlendScreen extends StatefulWidget {
  @override
  _OtBlendScreenState createState() => _OtBlendScreenState();
}

class _OtBlendScreenState extends State<OtBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/ot_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: otFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(otFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
