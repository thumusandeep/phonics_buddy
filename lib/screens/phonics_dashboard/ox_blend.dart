// lib/screens/phonics_dashboard/ox_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/ox_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class OxBlendScreen extends StatefulWidget {
  @override
  _OxBlendScreenState createState() => _OxBlendScreenState();
}

class _OxBlendScreenState extends State<OxBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/ox_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: oxFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(oxFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
