// lib/screens/phonics_dashboard/ub_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/ub_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class UbBlendScreen extends StatefulWidget {
  @override
  _UbBlendScreenState createState() => _UbBlendScreenState();
}

class _UbBlendScreenState extends State<UbBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/ub_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: ubFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(ubFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
