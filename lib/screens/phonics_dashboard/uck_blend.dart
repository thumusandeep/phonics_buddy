// lib/screens/phonics_dashboard/uck_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/uck_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class UckBlendScreen extends StatefulWidget {
  @override
  _UckBlendScreenState createState() => _UckBlendScreenState();
}

class _UckBlendScreenState extends State<UckBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/uck_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: uckFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(uckFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
