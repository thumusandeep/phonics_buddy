// lib/screens/phonics_dashboard/ud_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/ud_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class UdBlendScreen extends StatefulWidget {
  @override
  _UdBlendScreenState createState() => _UdBlendScreenState();
}

class _UdBlendScreenState extends State<UdBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/ud_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: udFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(udFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
