// lib/screens/phonics_dashboard/um_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/um_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class UmBlendScreen extends StatefulWidget {
  @override
  _UmBlendScreenState createState() => _UmBlendScreenState();
}

class _UmBlendScreenState extends State<UmBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/um_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: umFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(umFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
