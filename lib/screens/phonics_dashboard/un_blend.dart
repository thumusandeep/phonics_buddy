// lib/screens/phonics_dashboard/un_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/un_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class UnBlendScreen extends StatefulWidget {
  @override
  _UnBlendScreenState createState() => _UnBlendScreenState();
}

class _UnBlendScreenState extends State<UnBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/un_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: unFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(unFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
