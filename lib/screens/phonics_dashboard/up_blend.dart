// lib/screens/phonics_dashboard/up_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/up_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class UpBlendScreen extends StatefulWidget {
  @override
  _UpBlendScreenState createState() => _UpBlendScreenState();
}

class _UpBlendScreenState extends State<UpBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/up_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: upFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(upFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
