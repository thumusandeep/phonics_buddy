// lib/screens/phonics_dashboard/ut_blend.dart

import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../data/phonics_content/ut_data.dart';
import '../../widgets/animated_phonics_circle.dart';
import 'dart:ui';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class UtBlendScreen extends StatefulWidget {
  @override
  _UtBlendScreenState createState() => _UtBlendScreenState();
}

class _UtBlendScreenState extends State<UtBlendScreen> {
  ...
  void _play(String folder, String fileName) async {
    ...
    if (folder == 'word') path = "audio/words/cvc/3_letters/ut_blend_words/${fileName.toLowerCase()}.mp3";
        ...
        child: Stack(
          ...
          children: [
            PageView.builder(
              ...
              itemCount: utFamilyWords.length,
              itemBuilder: (context, index) {
                return _buildLessonPage(utFamilyWords[index]);
              },
            ),
            Positioned(
              bottom: 40,
